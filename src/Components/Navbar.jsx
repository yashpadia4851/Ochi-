...
const Navbar = () => {
  return (
    <div className="fixed z-[999] py-8 w-full px-20 font-['Neue_Montreal'] flex justify-between items-center">
      <div className="log">
        <svg
          width="72"
          height="30"
      ...
      <div className="links flex gap-14 text-lg capitalize ">
        ...
        <div className="ml-32">Contact</div>
      </div>
    </div>
  );
};
